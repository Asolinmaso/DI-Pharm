        ...
        <div className="footer-content">
          <div className="footer-column footer-company">
            ...
            <div className="footer-social">
              <a href="https://www.facebook.com/profile.php?id=61571431221147" target="_blank" rel="noopener noreferrer" className="footer-social-icon" aria-label="Facebook">
                <svg
                  width="38"
                  height="38"
                  viewBox="0 0 38 38"
              ...
              <a href="https://wa.me/919677787817" target="_blank" rel="noopener noreferrer" className="footer-social-icon" aria-label="Whatsapp">
                <svg
                  width="37"
                  height="37"
                  viewBox="0 0 37 37"
              ...
              <a href="https://www.linkedin.com/company/di-pharma-innovation-pvt-ltd/" target="_blank" rel="noopener noreferrer" className="footer-social-icon" aria-label="LinkedIn">
                <svg
                  width="28"
                  height="28"
                  viewBox="0 0 28 28"
          ...
          <div className="footer-column footer-contact">
            ...
            <div className="footer-contact-item">
              ...
              <div className="footer-phone-list">
                <a href="tel:9677787817" className="footer-phone-link">
                  +91-9677787817
                </a>
                <a href="tel:7397787817" className="footer-phone-link">
                  +91-7397787817
                </a>
                <a href="tel:8778359643" className="footer-phone-link">
                  +91-8778359643
                </a>
              </div>
            </div>
            ...
            <div className="footer-contact-item">
              <svg
                ...
                xmlns="http://www.w3.org/2000/svg"
              >
                <path d="M3.06489 21C2.47626 21 1.98517 20.802 1.59161 20.406C1.19806 20.01 1.00085 19.5154 1 18.9223V5.07771C1 4.48543 1.1972 3.99129 1.59161 3.59529C1.98602 3.19929 2.47668 3.00086 3.06361 3H21.9364C22.5242 3 23.0148 3.19843 23.4084 3.59529C23.8019 3.99214 23.9991 4.48629 24 5.07771V18.9236C24 19.515 23.8028 20.0091 23.4084 20.406C23.014 20.8029 22.5233 21.0009 21.9364 21H3.06489ZM12.5 11.9486C12.6065 11.9486 12.7061 11.9323 12.799 11.8997C12.891 11.8671 12.9821 11.8273 13.0724 11.7801L22.3095 5.69486C22.4305 5.62114 22.5093 5.52043 22.5459 5.39271C22.5825 5.265 22.5757 5.13771 22.5254 5.01086C22.4931 4.84543 22.3857 4.72543 22.2034 4.65086C22.022 4.57714 21.8461 4.59214 21.6757 4.69586L12.5 10.7143L3.32556 4.69714C3.15519 4.59257 2.98311 4.57029 2.80933 4.63029C2.63556 4.69029 2.52396 4.80857 2.47456 4.98514C2.42515 5.11714 2.41876 5.25129 2.45539 5.38757C2.49202 5.52386 2.57039 5.62671 2.6905 5.69614L11.9276 11.7801C12.0179 11.8273 12.109 11.8671 12.201 11.8997C12.2939 11.9314 12.3935 11.9473 12.5 11.9473" />
              </svg>
              <a href="mailto:contact@dipharmainnovation.com" className="address-link">
                contact@dipharmainnovation.com
              </a>
            </div>
          </div>
          ...
          <div className="footer-column footer-follow-mobile">
            ...
            <div className="footer-social">
              ...
              <a href="mailto:contact@dipharmainnovation.com" className="footer-social-icon" aria-label="Email">
                <svg
                  width="24"
                  height="24"
                  viewBox="0 0 24 24"
